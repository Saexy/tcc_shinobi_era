	...
	<body>
				...
				<div class="col s12 m10 offset-m1">
					<div class="section">
						<div class="col s6 offset-s3 white z-depth-4">
							<form name="frmfase" method="post"  enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF'];?>" class ="col s12 m10 offset-m1 l10 offset-l1">
								<div class="row center">
									<div class="container">
										...
										<div class="input-field col s12">
											<textarea id="idslogan" name="slogan" class="materialize-textarea"></textarea>
		...
		<?php
				if(isset($_POST['enviar'])){
					...
					include_once('../../classes/ImagemFases.class.php');
					...
					if($errodaimagem){
						...
						$fase = new Fase();
						$fase->startFase($id, $fotoorigin, $fotoatual, $titulo, $slogan);
						$mensagem[] = $fase->insertFase();
					}else{
						$mensagem[] = 'Fase não foi incluida na base de dados';
					}
