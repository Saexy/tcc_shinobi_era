	...
	<body>
							...
							<form name="frmlogin" method="post"  enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF'];?>" class ="col s12 m10 offset-m1 l10 offset-l1">
								<div class="row center">
									<div class="container">
										...
										<div class="input-field col s12">
											<input type="text" name="titulo" id="idtitulo" value="<?php echo $fase[3];?>"/>
											<label for="idtitulo" class="black-text">Título</label>
										</div>
										<div class="input-field col s12">
											<textarea id="idslogan" name="slogan" class="materialize-textarea"><?php echo $fase[4];?></textarea>
		...
		<?php
			if(isset($_POST['enviar']))
			{
				...
				$rtn = $editfase->editFase($id, $titulo, $slogan);
