	...
	<body>
								...
								<div class="row center">
									<div class="container">
										...
										<div class="input-field col s12">
											<input type="text" name="id" readonly id="idid" value="<?php echo $fase[0];?>"/>
											<label for="idid" class="black-text">ID</label>
										</div>
										<div class="input-field col s12">
											<img src="<?php echo $fase[2];?>" alt="" style="width: 80%;">
										</div>
										<div class="input-field col s12">
											<input type="text" name="titulo" readonly id="idtitulo" value="<?php echo $fase[3];?>"/>
											<label for="idtitulo" class="black-text">Título</label>
										</div>
										<div class="input-field col s12">
											<textarea id="idslogan" name="slogan" readonly class="materialize-textarea"><?php echo $fase[4];?></textarea>
          									<label for="idslogan" class="black-text">Slogan</label>
										</div>
										<div class="input-field col s12 m12 l6 offset-l3">
											<p>Você realmente quer excluir esta fase?
												<label>
		...
		<?php
				if(isset($_POST['enviar']))
				{
					...
					if($confirma == 'sim'){
						$rtn = $excluifase->deleteFase($id);
						
						if($rtn == 1){
							header("Location:listafase.php");
						}else{
							header("Location:listafase.php");
						}
					}else{
