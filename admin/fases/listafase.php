			...
			<?php
				...
				if($retorno) {
							...
							<div class="listslider col s6 offset-s3 white lighten-5 z-depth-1">
								<div class="valign-hrapper">
									<div class="containerslider">
										<div class="col s2">
											<img style="width: 70%;" src="'.$fase[2].'" />
										</div>
										<div class="col s8 card-content black-text">'.$fase[0].' | '.$fase[3].'</div>
										<div class="col s2">
											<a href="editafase.php?cod='.$fase[0].'"><i class="material-icons black-text">edit</i></a>
											<a href="excluifase.php?cod='.$fase[0].'"> <i class="material-icons black-text">delete</i></a></div>
										</div>
									</div>		
								</div>
							</div>
					...
					<div class="row center">
						<div class="white-text">Não existe lista de fases no momento.</div>
					</div>
					<div style="height: 200px;">
					</div>
